...
Shader "LothsShade/GlitchTranslucent"
{
	Properties
	{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 clampResult84 = clamp( ( _HighlightColor * ( saturate( (temp_output_15_0*_HighlightSharpness + _HighlightOffset) ) - ( 1.0 - saturate( temp_output_141_0 ) ) ) ) , float4( 0,0,0,0 ) , float4( 0.5,0.5,0.5,0 ) );
			...
			float temp_output_186_0 = ( 1.0 - temp_output_141_0 );
			float temp_output_151_0 = saturate( ( temp_output_141_0 + saturate( temp_output_186_0 ) ) );
			float4 temp_cast_1 = (temp_output_151_0).xxxx;
			...
			c.rgb = ( ( ( tex2D( _Emission, uv_Emission ) * _EmissionColor ) + ( saturate( clampResult84 ) + ( ( tex2D( _Diffuse, uv_Diffuse ) * _MainColor ) * temp_output_10_0 ) ) ) + ( saturate( ( ( ase_lightAtten * dotResult3 ) * pow( ( 1.0 - saturate( ( dotResult38 + _RimOffset ) ) ) , _RimPower ) ) ) * ( _RimColor * ase_lightColor ) ) ).rgb;
			c.a = _Translucency;
			return c;
		}
		...
		ENDCG
		CGPROGRAM
		#pragma surface surf StandardCustomLighting alpha:fade keepalpha fullforwardshadows exclude_path:deferred nolightmap  nodirlightmap vertex:vertexDataFunc 
...
/*ASEBEGIN
Version=16100
2161;29;1504;1034;-3168.326;-117.3795;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-1661.836,39.56157;Float;False;Property;_ShadowSharpness;ShadowSharpness;18;0;Create;True;0;0;False;0;100;1.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;67;-1641.013,132.0357;Float;False;Property;_ShadowOffset;ShadowOffset;19;0;Create;True;0;0;False;0;-50;-0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;167;-908.7751,-116.3001;Float;False;285;303;Comment;1;141;Combine Shade, Lightmap and Shadow;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;141;-858.7751,-66.30014;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;77;915.1548,-869.0199;Float;False;Property;_HighlightSharpness;HighlightSharpness;14;0;Create;True;0;0;False;0;100;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;945.7184,-779.5408;Float;False;Property;_HighlightOffset;HighlightOffset;15;0;Create;True;0;0;False;0;-80;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;186;-855.709,292.2218;Float;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;201;85.61084,-347.412;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;24;1966.407,1094.001;Float;False;Property;_RimOffset;Rim Offset;4;0;Create;True;0;0;False;0;0.24;0.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;199;-578.4276,196.9624;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;197;-540.6992,93.06219;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;83;1659.127,-1060.3;Float;False;Property;_HighlightColor;HighlightColor;13;0;Create;True;0;0;False;0;0.3773585,0.3773585,0.3773585,0;0.9882945,1,0.9009434,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;151;-381.6902,-8.907547;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;2398.407,1110.001;Float;False;Property;_RimPower;Rim Power;3;0;Create;True;0;0;False;0;0.5;10;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;34;2862.407,1094.001;Float;False;Property;_RimColor;Rim Color;2;1;[HDR];Create;True;0;0;False;0;0,1,0.8758622,0;0,1,0.8758622,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;192;3985.75,1372.199;Float;False;Property;_FuckUp;FuckUp;23;0;Create;True;0;0;False;0;0;0.049;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;140;-1437.757,-410.4154;Float;False;Property;_LightmapSharpness;LightmapSharpness;21;0;Create;True;0;0;False;0;0;359.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;144;-1443.891,-319.1866;Float;False;Property;_LightmapOffset;LightmapOffset;20;0;Create;True;0;0;False;0;-50;-180.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;202;3724.714,344.2661;Float;False;Property;_Translucency;Translucency;22;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;4355.351,495.8133;Float;False;True;2;Float;ASEMaterialInspector;0;0;CustomLighting;LothsShade/GlitchTranslucent;False;False;False;False;False;False;True;False;True;False;False;False;False;False;True;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;ForwardOnly;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;4;6.95;23.32;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;1;False;-1;1;False;-1;0;False;0.02;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=50632558DDD7624A308E8CE2EF10204D2AC7EF03